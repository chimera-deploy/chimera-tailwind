...
const Content = () => {
  ...
  const sectionDiv = 'md:mx-64 mx-12'
  const mainHeader = 'font-koulen text-tyrianpurple text-4xl text-center my-6'
  const subHeader = 'font-koulen text-tyrianpurple text-2xl text-center my-6'
  const textDiv = 'font-sans text-lg space-y-3'
  const imageCaption = 'italic text-center'
    ...
    <>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={monololithArchitecture} alt="monolith architecture"></img>
          ...
          <figure>
            <img src={microserviceArchitecture} alt="microservice architecture"></img>
          ...
          <figure>
            <img src={containerOrchestrator} alt="container orchestration"></img>
          ...
          <figure>
            <img src={serviceMesh} alt="service mesh"></img>
          ...
          <figure>
            <img src={serviceMesh} alt="percentage based traffic routing between services"></img>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={cicdPipeline} alt="Chimera's place in a CI/CD pipeline"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={allAtOnceDeployment} alt="All-at-once Deployment"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={rollingDeployment} alt="Rolling Deployment"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={blueGreenDeployment} alt="Blue-Green Deployment"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={canaryDeployment} alt="Canary Deployment"></img>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={existingSolutions} alt="Existing Solutions"></img>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={routingOrchestrationOverview} alt="Routing and Orchestration"></img>
          ...
          <figure>
            <img src={canaryECSService} alt="Chimera Deploying Canary ECS Service"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={routingOrchestrationMetricsOverview} alt="Traffic Routing"></img>
          ...
          <figure>
            <img src={appMeshDetail} alt="App Mesh Components"></img>
          ...
          <figure>
            <img src={canaryNodeECS} alt="Deploying Canary ECS Service and Virtual Node"></img>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={routingOrchestrationMetricsHighlightedOverview} alt="Routing Orchestration and Monitoring"></img>
          ...
          <figure>
            <img src={fullChimera} alt="The Many Parts of Chimera"></img>
          ...
          <figure>
            <img src={rollback} alt="Rolling Back a Failed Deployment"></img>
          ...
          <figure>
            <img src={cleanup} alt="Cleaning Up After a Successfull Deployment"></img>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={baseInfrastructure} alt="Base Infrastructure"></img>
          ...
          <figure>
            <img src={prepareECSCluster} alt="Prepare ECS Cluster"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
          ...
          <figure>
            <img src={configureNewService} alt="Configuring New Service and Selecting Deployment Options"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
          ...
          <figure>
            <img src={beginDeployment} alt="Beginning Deployment"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={manyCloudWatchAgents} alt="CloudWatch Agents added to every service"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
          ...
          <figure>
            <img src={oneCloudWatchAgent} alt="CloudWatch Agent added to only one service"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
        ...
        <h3 className={subHeader}>What Canary Deployment Strategy Will Chimera Use?</h3>
          ...
          <figure>
            <img src={baseline} alt="Baseline service used with a canary"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
          ...
          <figure>
            <img src={noBaseline} alt="No baseline service used with a canary"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
      ...
      <div className={sectionDiv}>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={CICDPipeline} alt="Chimera integrated as a fully automatic CICD pipeline"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
        ...
        <div className={textDiv}>
          ...
          <figure>
            <img src={webhook} alt="Chimear integrated with webhooks"></img>
            <figcaption className={imageCaption}></figcaption>
          </figure>
        </div>
      </div>
